    ...
    def databaru(self):
        ...
        # Input Password
            ...
            if 8 <= len(password) <= 20 and any(char.isupper() for char in password) and any(char.islower() for char in password) and any(char.isdigit() for char in password):
                break
            elif 8 <= len(password) <= 20 and any(char.islower() for char in password) and any(char.isdigit() for char in password) or 8 <= len(password) <= 20 and any(char.isupper() for char in password) and any(char.islower() for char in password) or 8 <= len(password) <= 20 and any(char.isupper() for char in password) and any(char.isdigit() for char in password):
                print("Password yang anda masukkan terlalu lemah, gunakan minimal satu huruf kapital, huruf kecil dan angka")
            elif 8 <= len(password) <= 20 and any(char.islower() for char in password) or 8 <= len(password) <= 20 and any(char.isupper() for char in password) or 8 <= len(password) <= 20 and any(char.isdigit() for char in password):
                print("Password yang anda masukkan terlalu lemah, gunakan minimal satu huruf kapital, huruf kecil dan angka")
            else:
